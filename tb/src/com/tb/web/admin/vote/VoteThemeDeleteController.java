...
@Controller
@RequestMapping("/admin/voteThemeDelete.html")
public class VoteThemeDeleteController {
	@Autowired
	...
	public ModelAndView doGet(HttpServletRequest request,HttpServletResponse response) throws IOException{
		...
		voteOptionService.deleteByThemeId(id);
		voteQuizService.deleteByThemeId(id);
		voteThemeService.deleteById(id);
