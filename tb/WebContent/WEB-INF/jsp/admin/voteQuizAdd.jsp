	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="text-left">
					<div class="well">
						<form name="quizForm" role="form" method="POST">
							<div class="form-group">
								<label for="quiz">问题内容</label> <input type="text"
									class="form-control" name="quiz" id="quiz" placeholder="问题内容">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="hidden" class="form-control" name="themeId"
									value="${themeId}">
							</div>						
						</form>
					</div>
					...
					<script>
						...
						function quizSave() {
							var quizLength = $('#quiz').val().length;							
							if (quizLength > 128) {
								alert("问题内容请不要超过128个字符！");
								return;
							}
							if(quizLength > 0  ){				    		
					    		window.onbeforeunload = null;
					    		document.quizForm.action="voteQuizAdd.html"; 
