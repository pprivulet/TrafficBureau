			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="text-left">
						...
						<form name="themeForm" role="form" method="POST">
							<div class="form-group">
								<label for="quiz">问题内容</label> <input type="text"
									class="form-control" name="quiz" id="quiz" placeholder="问题内容" value=<c:out
												value="${voteQuiz.content}"
												escapeXml="true" />>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="hidden" class="form-control" name="quizId"
									value="${voteQuiz.id}">
							</div>						
						</form>
					</div>
					...
					<script>
						...
						function quizSave() {
							var themeLength = $('#quiz').val().length;							
							if (themeLength > 128) {
							...
							if(themeLength > 0  ){				    		
					    		...
					    		document.themeForm.action="voteQuizEdit.html"; 
