...
(function($){
    dk_slideplayer = function(object,config){
        ...
        this.resetclass =function(obj,i){
            $(obj).css({float:"left",marginRight:"3px",width:"15px",height:"14px",lineHeight:"15px",textAlign:"center",fontWeight:"800",fontSize:"12px",color:"#000",background:"#c4c4c4",cursor:"pointer"});
            $(obj).eq(i).css({color:"#FFFFFF",background:"#5E5E60",textDecoration:"none"});
        }
        this.factory();
    }
})(jQuery)
